...
import com.mvcTest.entity.entityAssociation.oneToOne.Event;
import com.mvcTest.entity.entityAssociation.oneToOne.Person;
import com.mvcTest.service.impl.CRUD_service_impl;
...
public class InitDataToDb {
    ...
    private void init() {
        ...
        CRUD_service_impl crud_service_impl = new CRUD_service_impl();
        crud_service_impl.saveOrUpdate(student);
